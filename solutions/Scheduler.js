...
export default class Scheduler{
    ...
    /**
     * A function that find available time slots and create new study seession for an assignment
     * @param {AssignmentEvent} assignment 
     * @param {Array<UserEvent|AssignmentEvent|StudySession>} events - all existing events
     * @returns {Array<StudySession>} study_sessions - newly created 
     */
    allocate_sessions(assignment, events) {
        ...
        /* Allocate slots. note: the following code was generated by ChatGPT, it works but somehome complicated*/
        let allocated_slots = [];
        let slots_by_day = {};
        ...
        /* Create study sessions from the allocated slots */
        let study_sessions = [];
        ...
        /* Add the newly create study sessions to the plan */
        assignment.study_plan.sessions = study_sessions;
        return study_sessions;
    }

    /**
     * A function that reallocate a study session that conflicted with a user event
     * Note: if there is no available time slot, it will trigger warn() without re-allocate the study session
     * @param {StudySession} session - the study session that needs to be reallocated
     * @param {Array<UserEvent|AssignmentEvent|StudySession>} events - all existing events
    ...
    /**
     * A protected function that warns user if there is no available time slots
     * Note: currently just logging a string to the console
     * @returns {void} Nothing
     */
    _warn(){
    ...
    /**
     * A protected function that finds all the available time slots
     * Note: The code the was generated by ChatGPT with minor modification
     * @param {Array<UserEvent|AssignmentEvent|StudySession>} events - all existing events
     * @param {Date} searchStart - start time for the search
     * @param {Date} searchEnd - end time for the search
     * @returns {Array<TimeSlot>} freeSlots
     */
    ...
    /**
     * A protected function that finds all the available time slots with a minimum duration in minutes
     * Note: The code the was generated by ChatGPT with minor modification
     * @param {Array<UserEvent|AssignmentEvent|StudySession>} events - all existing events
     * @param {Date} searchStart - start time for the search
     * @param {Date} searchEnd - end time for the search
     * @param {number} minDurationMinutes
     * @returns {Array<TimeSlot>} allFreeSlots
     */
    ...
    /**
     * A protected function that exclode block times from from the free_slots, guaranteeing minimum duration
     * Note: The code the was generated by ChatGPT with minor modification
     * @param {Array<TimeSlot>} free_slots
     * @param {number} minimum - minimum duration in minutes
     * @returns {Map<string, Array<TimeSlot>>} results - e.g. {'2025-02-18: [TimeSlot, TimeSlot]', ...}
     */
    ...
    /**
     * A procted function that generates a next usable event id
     * @returns {number} id
     */
    _get_next_id(){
        this._id_counter += 1;
